...
static NSString *PID = @"15";
#define TEXT_COLOR [UIColor darkGrayColor]
#define TILE_COLOR [UIColor whiteColor]
static NSString *DB_FILENAME = @"zoncon_publishing.db";
static NSString *SHARE_MSG = @"ZonCon Publishing Morningmist App";
static NSString *SHARE_SUBJECT = @"ZonCon Publishing Morningmist App";
static NSString *SHARE_CONTENT = @"Thank you for downoading the ZonCon Publishing App!";
static NSString *FEEDBACK_EMAIL_SUBJECT = @"ZonCon Publishing Morningmist App Feedback";
